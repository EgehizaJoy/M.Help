...
<body>
		...
		<div class="container">
			...
			<div class="row block-9">
				<div class="col-md-8">
					<form action="connection.php" class="bg-light p-4 p-md-5 contact-form">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<textarea name="Story" id="Story" cols="30" rows="7" class="form-control" placeholder="Story(Your experience)"  ></textarea>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
				...
				<div class="col-md-4 d-flex pl-md-5">
					<div class="row">
						<div class="dbox w-100 d-flex">
							...
							<div class="image">
								<p>Stories from other survivors.</p>
							</div>
						</div>
...
$sql = "SELECT * FROM survivor_story";
