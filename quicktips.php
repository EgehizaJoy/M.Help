...
<body>
		...
		<div class="container">
			...
			<div class="row block-9">
				<div class="col-md-8">
					<form action="quickin.php" class="bg-light p-4 p-md-5 contact-form">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<textarea name="quicktip" id="Story" cols="30" rows="7" class="form-control" placeholder="book recomendation"  ></textarea>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
